...
import { Package, MapPin, Calendar, Flame, SlidersHorizontal, X, Filter, Tag, DollarSign, Percent, Sparkles, TrendingUp, TrendingDown, Clock, Plus, Star, Navigation } from 'lucide-react';
...
const DealsPage2 = () => {
  ...
  useEffect(() => {
    const loadInitialCategories = async () => {
      ...
      try {
        ...
        const countResponse = await categoriesAPI.getCategories({ 
          limit: 1,
          is_active: true 
        });
        const totalCount = countResponse.total || countResponse.data?.length || 0;
        setTotalCategoriesCount(totalCount);
        
        // Then load initial batch (let's say 6 categories initially)
        ...
        // If we loaded all categories, mark as showing all
        if (loadedCategories.length >= totalCount) {
  ...
  // Load all categories when expanding
        ...
        >
          ...
          <div className="relative max-w-6xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl mb-8 text-primary-100">
              From local warungs to premium restaurants - save more, eat better!
            </p>
          </div>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Categories Section - Before Hot Deals */}
      <div className="bg-white">
      <div className="max-w-6xl mx-auto px-4 py-6">
        <div className="mb-0">
          <h3 className="text-2xl font-bold text-gray-900 mb-4 text-center">Browse by Category</h3>
          <div className="flex flex-wrap justify-center gap-3">
            ...
            {!showAllCategories && categories.length > 0 && categories.length < totalCategoriesCount && (
              <button
                onClick={loadAllCategories}
                disabled={categoriesLoading}
                className="flex items-center gap-2 px-4 py-3 rounded-full text-sm font-medium transition-all duration-200 bg-gray-100 text-gray-700 hover:bg-gray-200 border border-gray-200 disabled:opacity-50"
              >
                {categoriesLoading ? (
                ...
                <span>{categoriesLoading ? 'Loading...' : `+${totalCategoriesCount - categories.length} More`}</span>
              </button>
            )}
            ...
            {selectedCategory && (
              <button
                ...
                className="flex items-center gap-2 px-4 py-3 rounded-full text-sm font-medium transition-all duration-200 bg-red-50 text-red-700 hover:bg-red-100 border border-red-200"
              >
                <X className="w-4 h-4" />
                <span>Clear</span>
              </button>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 mt-2 pt-6">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-3xl font-bold text-gray-900">Hot Deals Today</h2>
          </div>
          <div className="flex items-center md:gap-2 gap-0">
            ...
            >
              ...
              <span className="text-sm font-medium md:block hidden">{ showFilters ? "Close Filters" : "View Filters"}</span>
            </button>
        ...
        {showFilters && (
          <div className="rounded-lg mb-4">
            ...
            <div className="mb-4">
              ...
              <p className="text-xs text-gray-500 mb-2">Search by deal name, tags, or restaurant name</p>
              <input
                type="text"
                value={textSearchInput}
                onChange={(e) => setTextSearchInput(e.target.value)}
                placeholder="Enter deal name, tags, or restaurant name"
      ...
      {showFilters && (
        <div className="bg-gray-50 border-b border-gray-200 mb-6">
          <div className="max-w-6xl mx-auto px-4 py-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="block text-xs text-gray-500 mb-2">Min (RM)</label>
                    <input
                      type="number"
                      value={priceMinInput}
                  ...
                  <div>
                    <label className="block text-xs text-gray-500 mb-2">Max (RM)</label>
                    <input
                      type="number"
                      value={priceMaxInput}
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="block text-xs text-gray-500 mb-2">Min (%)</label>
                    <input
                      type="number"
                  ...
                  <div>
                    <label className="block text-xs text-gray-500 mb-2">Max (%)</label>
                    <input
                      type="number"
            ...
            >
              <X className="w-5 h-5" />
              <span className="text-sm font-medium md:block hidden">Clear</span>
            </button>
            </div>
          </div>
        </div>
        ...
        <div className="mb-6">
          {loading ? (
            ...
            <p className="text-gray-600">
              Showing {pagination.total_deals} amazing deals
            </p>
          )}
        </div>
